...
const Landing = () => {
    ...
    return (
        <div className="flex flex-col h-full text-white sm:px-10 justify-center sm:justify-start">
            <div className="justify-center sm:justify-start text-center sm:text-start">
                ...
                <div className="pt-8 sm:pt-16">
                    ...
                    <button className="font-casual text-xl sm:text-2xl py-4 px-10 sm:py-6 sm:px-16 mt-3 sm:mt-0 w-fit rounded bg-[#1AC472]" onClick={handleRegisterClick}>
                        <h1>Sign Up!</h1>
                    </button>
                </div>
            </div>
